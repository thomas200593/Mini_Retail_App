    ...
    Scaffold(
        ...
        bottomBar = {
            if(stateApp.shouldShowBottomBar){
                BottomBar(
                    destinations = stateApp.destinationTopLevels,
                    onNavigateToDestination = stateApp::navigateToDestinationTopLevel,
                    currentDestination = stateApp.destinationCurrent,
                    modifier = modifier
                )
            }
        },
