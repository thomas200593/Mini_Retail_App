...
import com.thomas200593.mini_retail_app.features.app_conf._g_currency.domain.UCFetchConfCurrency
...
class CurrencyViewModel @Inject constructor(
    ...
    val configData = UCFetchConfCurrency.invoke().flowOn(ioDispatcher)
        .stateIn(
