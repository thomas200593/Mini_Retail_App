package com.thomas200593.mini_retail_app.features.app_conf._gen_theme.ui
...
import com.thomas200593.mini_retail_app.features.app_conf._gen_theme.entity.ConfigThemes
...
fun ScrConfGenTheme(
    ...
    ScreenContent(configData = configData, onSaveSelectedTheme = vm::setTheme)
}
...
private fun TopAppBar(onNavigateBack: () -> Unit) {
    ...
    ProvideTopAppBarTitle {
        Row(
            ...
            Text(
                text = stringResource(id = str_theme),
                maxLines = 1,
                overflow = Ellipsis
            )
        }
...
private fun ScreenContent(
    configData: ResourceState<ConfigThemes>,
    ...
    when(configData){
        ...
        is Success -> {
            ...
            Column(
                ...
                Text(
                    text = "${stringResource(id = str_theme)} : ${stringResource(id = currentData.title)}",
