...
object AppConfig{
    data class ConfigCurrent(
        ...
        val country: Country = HelperCountry.COUNTRY_DEFAULT,
        val language: Language = Language.EN,
        val timezone: Timezone = HelperTimezone.TIMEZONE_DEFAULT,
        val currency: Currency = HelperCurrency.CURRENCY_DEFAULT
    )
