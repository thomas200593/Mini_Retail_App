...
import com.thomas200593.mini_retail_app.features.app_config.domain.GetCurrencyConfigUseCase
...
class CurrencyViewModel @Inject constructor(
    ...
    getCurrencyConfigUseCase: GetCurrencyConfigUseCase,
    @Dispatcher(Dispatchers.Dispatchers.IO) private val ioDispatcher: CoroutineDispatcher
): ViewModel() {

    val configData = getCurrencyConfigUseCase.invoke().flowOn(ioDispatcher)
        .stateIn(
